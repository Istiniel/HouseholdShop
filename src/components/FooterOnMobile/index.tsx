    ...
    <footer className={st.footer}>
      <div className="wrapper">
        <div className={st.container}>
          <div className={st.subsribe}>
            <div className={st.about}>
              <div className={st.priceList}>
                ...
                <Button color="orange" padding="1.25rem 2.95rem">
                  <h3 className={st.priceListButton}>
                    Прайс-лист
                    <img src={pricelistLogo} alt="card__logo" />
                  </h3>
                </Button>
              </div>
              <p>
          ...
          <div className={st.contactsContainer}>
            <h2>Контакты:</h2>
          ...
          <div className={st.messengersContainer}>
